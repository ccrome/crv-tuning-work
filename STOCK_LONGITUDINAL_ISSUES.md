...
| Issue | Local route ID(s) | OpenPilot route ID(s) | Regression created | Implemented | Build hash | Validated on live drives | Current state |
|---|---|---|---|---|---|---|---|
| L1 — brief tracker loss | `route-5c` (`0000005c--3c70bb383d`); `route-22` (`00000022--21f81e5069`); `route-1e` (`0000001e--2d841e7d0b`) | TBD | Yes: [PR #5](https://github.com/ccrome/sunnypilot/pull/5) covers 16, 32, 56, and 72 mph | Yes: [PR #5](https://github.com/ccrome/sunnypilot/pull/5) | `208336e6dbd4acf1cbe16031ebccd36c8236ce62` (published; not installed) | No | Install, then collect a triggered drive |
| L2 — close stopped-lead restart | `route-5c` (`0000005c--3c70bb383d`); `route-1e` (`0000001e--2d841e7d0b`) | TBD | Yes: [PR #7](https://github.com/ccrome/sunnypilot/pull/7) adds the deterministic 2.7 m stopped-lead loss case | Yes: [PR #7](https://github.com/ccrome/sunnypilot/pull/7) | `208336e6dbd4acf1cbe16031ebccd36c8236ce62` (published; not installed) | No | Install and validate separately at low speed |
...
| L4 — no-lead speed regulation | `route-5c` (`0000005c--3c70bb383d`); `route-5d` (`0000005d--46b3832579`) | TBD | Yes: highway and moderate-speed log regressions; [PR #9](https://github.com/ccrome/sunnypilot/pull/9) adds the CR-V calibration regression | Yes: [PR #9](https://github.com/ccrome/sunnypilot/pull/9) is drafted but not built or installed | — | No matched candidate drive | Build, install, then collect matched moderate and highway runs |
...
- Automated check: `test_crv_brief_tracker_loss_regression.py` in
  [PR #5](https://github.com/ccrome/sunnypilot/pull/5). All four cases are
  required passes. The fix is awaiting build and live-drive validation.
